...
|---|-------|------|------------|--------|
| 1 | Portrait Shell & Board Skeleton | [stage-01-portrait-shell.md](stage-01-portrait-shell.md) | Scaffold on `main` | not started |
| 2 | Data-Driven Core Loop on Map 1 | [stage-02-core-loop.md](stage-02-core-loop.md) | Stage 1 | not started |
| 3 | Juice Engine & Web Performance Proof | [stage-03-juice-engine.md](stage-03-juice-engine.md) | Stage 2 | not started |
